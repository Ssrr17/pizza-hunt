...
function getPizza() {
  ...
  fetch(`/api/pizzas/${pizzaId}`)
    ...
    .then(printPizza) // Now add a .catch() so that any error takes the user back to the home page, using the window.history.back() method. The getPizza() method should now look as follows:
    .catch(err => {
      console.log(err);
